...
1. Download and install the [STM32CubeMX](http://www.st.com/en/development-tools/stm32cubemx.html)  tool and the related MCU package (i.e. STM32F4 for *NucleoF401* and *STEVAL_MKI109V3* and STM32H5 for *NucleoH503* and *STEVAL_MKI109D*).
...
8. Open a terminal emulator to see messages and configure it as 115200 8n1 for *NucleoF401*, *STEVAL_MKI109D* and *STEVAL_MKI109V3* or 921600 8n1 for *NucleoH503*.
9. Enjoy :-)

Please note that there might be additional extra steps.
...
- [STEVAL_MKI109D](https://github.com/STMicroelectronics/STMems_Standard_C_drivers/tree/master/_prj_STEVAL_MKI109D)
