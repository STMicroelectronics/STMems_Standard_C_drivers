/**
  ******************************************************************************
  * @file    spi_extended.c
  * @brief   This file provides code for configuring SPI instances operating in
  *          both 3-wire and 4-wire modes. It also includes SPI initialization 
  *          functions with predefined clock polarity and clock phase 
  *          configurations, intended for use with a wide range of sensor 
  *          variants.
  ******************************************************************************
  * @attention
  *
...
/* SPI1 extendend support init function */
...
/* SPI6 extendend support init function */
void MX_SPI6_Ext_Init(void)
{
  ...
  hspi6.Init.MasterReceiverAutoSusp = SPI_MASTER_RX_AUTOSUSP_ENABLE;
...
/* SPI1 support init function for 3-Wire mode */
...
/* SPI6 support init function for 3-Wire mode */
...
/* SPI1 extendend support init function for 3-Wire mode */
...
/* SPI6 extendend support init function for 3-Wire mode */
