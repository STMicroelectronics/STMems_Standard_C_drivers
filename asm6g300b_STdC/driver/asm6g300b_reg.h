/*
 ******************************************************************************
 * @file    asm6g300b_reg.h
 * @author  Sensors Software Solution Team
 * @brief   This file contains all the functions prototypes for the
 *          asm6g300b_reg.c driver.
 ******************************************************************************
 * @attention
 *
...
#ifndef ASM6G300B_REGS_H
#define ASM6G300B_REGS_H
...
#define ASM6G300B_STATARSX                             0x10
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t drive_stator_ok_rx                  : 1;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_statarsx_t;

#define ASM6G300B_STATARSZ                             0x11
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t drive_stator_ok_rz                  : 1;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_statarsz_t;

#define ASM6G300B_STATACCX                             0x12
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t a2d_nsat_ok_ax                      : 1;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_stataccx_t;

#define ASM6G300B_STATACCY                             0x13
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t a2d_nsat_ok_ay                      : 1;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_stataccy_t;

#define ASM6G300B_STATCOM1                             0x14
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t not_testmode                        : 1;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_statcom1_t;

#define ASM6G300B_STATCOM2                             0x15
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t avdd_high_ok                        : 1;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_statcom2_t;

#define ASM6G300B_CONFIG01                             0x16
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t iir_bw_sel_ax                       : 2;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_config01_t;

#define ASM6G300B_TEST_REG                             0x17
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t test_reg                            : 16;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_test_reg_t;

#define ASM6G300B_CONFIG02                             0x18
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t sensor_cmd                          : 7;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_config02_t;

#define ASM6G300B_MODE                                 0x19
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  uint16_t mode                                : 16;
...
#define ASM6G300B_ID_TRACKING0                         0x1A
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t tracking0                           : 16;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_tracking0_t;

#define ASM6G300B_COMBO_ID                             0x1B
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t combo_id                            : 16;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_combo_id_t;

#define ASM6G300B_ASIC_ID                              0x1C
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  uint16_t asic_id                             : 16;
...
#define ASM6G300B_ID_TRACKING1                         0x1D
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t tracking1                           : 16;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_tracking1_t;

#define ASM6G300B_ID_TRACKING2                         0x1E
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t tracking2                           : 16;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_tracking2_t;

#define ASM6G300B_CONFIG04                             0x1F
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t tdebrng_ax                          : 3;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_config04_t;

#define ASM6G300B_STATARSY                             0x20
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t drive_stator_ok_ry                  : 1;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_statarsy_t;

#define ASM6G300B_STATACCZ                             0x21
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t a2d_nsat_ok_az                      : 1;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_stataccz_t;

#define ASM6G300B_CONFIG05                             0x23
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t zclampconfig                        : 2;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_config05_t;

#define ASM6G300B_CONFIG06                             0x24
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t iir_bw_sel_ry                       : 2;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_config06_t;

#define ASM6G300B_I_FIR_ARSX                           0x25
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t i_fir_arsx                          : 16;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_i_fir_arsx_t;

#define ASM6G300B_I_FIR_ARSY                           0x26
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t i_fir_arsy                          : 16;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_i_fir_arsy_t;

#define ASM6G300B_I_FIR_ARSZ                           0x27
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t i_fir_arsz                          : 16;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_i_fir_arsz_t;

#define ASM6G300B_Q_FIR_ARSX                           0x28
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t q_fir_arsx                          : 16;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_q_fir_arsx_t;

#define ASM6G300B_Q_FIR_ARSY                           0x29
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t q_fir_arsy                          : 16;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_q_fir_arsy_t;

#define ASM6G300B_Q_FIR_ARSZ                           0x2A
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t q_fir_arsz                          : 16;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_q_fir_arsz_t;

#define ASM6G300B_ST_STATUS_ARS                        0x2B
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t auto_st_status_rx                   : 2;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_st_status_ars_t;

#define ASM6G300B_ST_STATUS_ACC                        0x2C
typedef struct
{
#if DRV_BYTE_ORDER == DRV_LITTLE_ENDIAN
  ...
  uint16_t auto_st_status_ax                   : 2;
#endif /* DRV_BYTE_ORDER */
} asm6g300b_st_status_acc_t;


#define ASM6G300B_PAGE                                 0x7F
...
typedef enum
{
  ASM6G300B_CMD_SOFT_RESET         = 0x03,
  ASM6G300B_CMD_HARD_RESET         = 0x07,
  ASM6G300B_CMD_WAKE_UP            = 0x09,
  ASM6G300B_CMD_LP_MODE            = 0x0F,
  ASM6G300B_CMD_START_SELF_TEST    = 0x11,
  ASM6G300B_CMD_STOP_SELF_TEST     = 0x12,
  ASM6G300B_CMD_XL_AUTO_SELF_TEST  = 0x1D,
  ASM6G300B_CMD_GY_AUTO_SELF_TEST  = 0x1E,
  ASM6G300B_CMD_ALL_AUTO_SELF_TEST = 0x1F,
  ASM6G300B_CMD_GY_RESTART         = 0x21,
  ASM6G300B_CMD_EOI                = 0x7F,
} asm6g300b_commands_t;
int32_t asm6g300b_set_command(const stmdev_ctx_t *ctx, asm6g300b_commands_t cmd);

/* IIR Filter values */
#define ASM6G300B_IIR_FILTER_60HZ   0x0
#define ASM6G300B_IIR_FILTER_30HZ   0x1
#define ASM6G300B_IIR_FILTER_15HZ   0x2
#define ASM6G300B_IIR_FILTER_300HZ  0x3
#define ASM6G300B_IIR_FILTER_227HZ  0x3

/* debounce timer values */
#define ASM6G300B_DEBOUNCE_TIME_0MS      0x0
#define ASM6G300B_DEBOUNCE_TIME_2_86MS   0x1
#define ASM6G300B_DEBOUNCE_TIME_5_71MS   0x2
#define ASM6G300B_DEBOUNCE_TIME_8_57MS   0x3
#define ASM6G300B_DEBOUNCE_TIME_11_43MS  0x4
#define ASM6G300B_DEBOUNCE_TIME_14_29MS  0x5
#define ASM6G300B_DEBOUNCE_TIME_17_14MS  0x6
#define ASM6G300B_DEBOUNCE_TIME_20MS     0x7

/* z-clamp values */
#define ASM6G300B_NVM_CLIPPING_DEFAULT            0x0
#define ASM6G300B_NVM_CLIPPING_DEFAULT_PLUS_1g    0x1
#define ASM6G300B_NVM_CLIPPING_DEFAULT_MINUS_1g   0x2
...
#define ASM6G300B_ST_STATUS_MASK 0x003F003F
#define ASM6G300B_ST_STATUS_OK   0x00150015
