...
This folder contains application examples for FXPS7400A4S absolute pressure sensor family. 
...
## Analog only output sensor examples
  ...
  1. fxps7400_analog_output_read.c:<br>
     Details: Reads analog output from FXPS7400A4S using ADC interrupt mode.
  ...
  2. fxps7400_analog_output_stream.c:<br>
     Details: Continuously reads FXPS7400A4S analog output using ADC interrupt mode.
...
To run the FXPS7400 analog output example, the application flow differs from the previous digital sensor examples.
