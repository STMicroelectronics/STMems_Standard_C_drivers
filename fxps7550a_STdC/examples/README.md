...
## Analog only output sensor examples
  ...
  1. fxps7550_analog_output_read.c:<br>
     Details: Reads analog output from FXPS7550A4S using ADC interrupt mode.
  ...
  2. fxps7550_analog_output_stream.c:<br>
     Details: Continuously reads FXPS7550A4S analog output using ADC interrupt mode.
...
To run the FXPS7550 analog output example, the application flow differs from the previous digital sensor examples.
